    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        .title("Gymunity API")
                        .version("1.0.0")
                        .description("API REST para la gestión de gimnasios, clases y usuarios. " +
                                "Sistema completo de autenticación JWT, valoraciones, inscripciones y estadísticas.")
                        .contact(new Contact()
                                .name("Gymunity Team")
